...
const sw=read('service-worker.js');['v3-0-0-rc-1','./diagnostico.html','./js/diagnostics.js','./js/onboarding.js','./css/diagnostics.css'].forEach(token=>must(sw.includes(token),`Cache RC sem ${token}`));

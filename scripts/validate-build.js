...
for(const required of ['service-worker.js','manifest.json','js/resilience.js','css/global.css'])if(!fs.existsSync(path.join(root,required)))errors.push(`Arquivo essencial ausente: ${required}`);

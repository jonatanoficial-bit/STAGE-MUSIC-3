...
const html=read('modo-live.html'), js=read('js/live-mode.js'), css=read('css/live.css'), sw=read('service-worker.js'), info=read('BUILD-INFO.json');
ok(info.includes('v4.3.0'),'Build info v4.3.0');
...
ok(sw.includes('stage-music-v4-3-0'),'Service Worker atualizado');

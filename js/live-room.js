...
const getProfile=()=>{const stored=read(PROFILE_KEY,{}),safe=sharing?.safeProfile?.(window.StageMusicAuth?.getState?.(),stored)||{name:stored.name||'Músico',instrument:stored.instrument||'Outro'};return {...safe,viewMode:stored.viewMode||'auto'}};

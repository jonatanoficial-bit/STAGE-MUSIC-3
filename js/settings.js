(function(){
  ...
  const MANAGED_KEYS=[
    ...
    'stage_music_live_profile','stage_music_active_setlist','stage_music_stage_checklist_v1','stage_music_onboarding_completed_v1'
  ];
  const ARRAY_KEYS=new Set(['stage_music_local_songs','stage_music_favorites','stage_music_recent_songs','stage_music_setlists_v1','stage_music_teams_v1','stage_music_events_v1']);
  const ID_ARRAY_KEYS=new Set(['stage_music_local_songs','stage_music_setlists_v1','stage_music_teams_v1','stage_music_events_v1']);
